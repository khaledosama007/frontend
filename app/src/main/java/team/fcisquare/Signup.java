...
public class Signup extends AppCompatActivity {
    ...
    private void signMeNow(final User user) {
        params = new HashMap<String, String>();
        params.put("name", user.getName());
        params.put("email", user.getEmail()); //Note: The backend side should check if a another user registered with the same email
        ...
        Connection postCon = new PostConnection(params, new ConnectionListener() {
            ...
            public void getResult(String result) {
                try {
                    ...
                    signInParams.put("email", user.getEmail());
                    signInParams.put("pass", user.getPass());
