...
public class Search extends AppCompatActivity {
            ...
            connection = new PostConnection(params, new ConnectionListener() {
                ...
                public void getResult(String result) {
                    try {
                        ...
                        SearchUsers searchUsers = new SearchUsers(getBaseContext(), users);
    ...
    class SearchUsers extends ArrayAdapter<User>{
        private ArrayList<User> users;
        public SearchUsers(Context context,ArrayList<User> users){
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Button button = (Button)convertView.findViewById(R.id.follow_user);
            textView.setText(users.get(position).getName());
            //change button according to following or not
            return convertView;
        }
    }
}
